...
function Scene3() {
  ...
  return (
    <div>
      ...
      <div className="absolute left-[100px] right-[85px] top-[12.93%] bottom-[83.25%] font-sans not-italic font-[600] text-[28px] tracking-[-0.0075em] leading-[110%] rounded-[10px] text-[#1D1E20]">
        Sign Up
      </div>
      <FontAwesomeIcon
        icon={faCheck}
        size="sm"
        style={{ color: "#34c358" }}
        className="absolute w-[11.67px] h-[11.67px] left-[339.17px]c"
      />
